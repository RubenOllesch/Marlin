...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_MIN         2 // (0-255) Minimum speed. (If set below this value the fan is turned off.)
  #define CONTROLLERFAN_SPEED_ACTIVE     16 // (0-255) Active speed, used when any motor is enabled
 ...
 */
#define FAN_MIN_PWM 2
#define FAN_MAX_PWM 226
...
#define FAST_PWM_FAN      // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
  ...
  #define FAST_PWM_FAN_FREQUENCY 7'500    // Define here to override the defaults below
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  54.1        // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X   0.11       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  47.9        // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y   0.084      // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
#define ARC_SUPPORT                   // Requires ~3226 bytes
  ...
  #define MAX_ARC_SEGMENT_MM      0.2 // (mm) Maximum length of each arc segment
